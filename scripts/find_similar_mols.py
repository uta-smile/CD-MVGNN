...
from dglt.data.dataset.utils import get_data_from_smiles, get_smiles
from dglt.data.featurization.mol2features import morgan_binary_features_generator
from dglt.models import MPNN
from dglt.models.nn_utils import compute_molecule_vectors
from dglt.utils import load_checkpoint, makedirs
...
def find_similar_mols(test_smiles: List[str],
    ...
    :param model: A trained MPNN (only needed for distance_measure == 'embedding').
