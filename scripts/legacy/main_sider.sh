...
python train.py  --data_path /opt/ml/env/$dataset_csv --dataset_type classification --save_dir /opt/ml/model/checkpoints \
                 --num_folds 5 --split_type scaffold_balanced --ensemble_size 5 --batch_size 32 \
                 --features_generator rdkit_2d_normalized --no_features_scaling \
                 --dropout 0.05 --depth 5 --ffn_num_layers 1 --hidden_size 14 \
                 --epochs 30  --init_lr 0.0001 --max_lr 10 --final_lr 1   &
sleep 5
