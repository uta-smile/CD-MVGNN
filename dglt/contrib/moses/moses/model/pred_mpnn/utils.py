...
def filter_invalid_smiles(mol_dataset: MoleculeDataset) -> MoleculeDataset:
    """
    ...
    """
    return MoleculeDataset([datapoint for datapoint in mol_dataset.data
...
def get_data(path: str,
    ...
    with open(path) as f:
        ...
        data = MoleculeDataset(list(Parallel(n_jobs=40)(
