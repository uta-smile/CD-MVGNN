...
from dglt.contrib.moses.moses.data.mpnn.data import StandardScaler
# from dglt.contrib.moses.moses.model.mpnn.model import build_model, MoleculeModel
from dglt.contrib.moses.moses.model.mpnn.nn_utils import NoamLR
...
def build_lr_scheduler(optimizer: Optimizer, args: Namespace, total_epochs: List[int] = None) -> _LRScheduler:
    ...
    return NoamLR(
        ...
        max_lr=[args.max_lr * args.init_lr],
        final_lr=[args.final_lr * args.init_lr]
    )
