...
from dglt.data.dataset.molecular import MoleculeDatapoint, MoleculeDataset
from dglt.data.featurization import load_features
from dglt.data.transformer.scaffold import log_scaffold_stats, scaffold_split
...
def validate_data(data_path: str) -> Set[str]:
    ...
    # Validate smiles
    for smile in tqdm(smiles, total=len(smiles), disable=True):
